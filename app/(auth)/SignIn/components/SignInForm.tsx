...
const SignInForm = () => {
  ...
  return (
    <>
      <form className="hidden lg:flex flex-col bg-white rounded-[24px] pb-[20px] 2xl:pb-[40px] pt-[40px] 2xl:pt-[80px] max-w-[520px] px-[40px] items-center z-[5000] gap-y-4 2xl:gap-y-6">
...
const MobileSignInForm = () => {
  ...
  const [showPassword, setShowPassword] = useState(false)
  return (
    <form className="flex flex-col bg-white rounded-[24px] px-[20px] pt-[20px] pb-[40px] w-[90vw] items-center z-[5000] gap-y-[1vh] max-w-[400px] md:max-w-[550px] lg:hidden">
