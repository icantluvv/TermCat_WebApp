...
const MobileSignUpForm = () => {
  ...
  return (
    <div className="flex flex-col my-[5vh] bg-white rounded-[24px] px-[20px] pt-[20px] pb-[40px] w-[90vw] items-center z-[5000] gap-y-[1vh] max-w-[400px] md:max-w-[550px] lg:hidden">
      <div className="flex-col flex w-full gap-y-[1vh] mb-[1vh]">
        ...
        <p className="text-center text-[0.875rem] md:text-[1rem] text-[#a1a1a1] leading-snug">
          ...
          <br className="hidden md:flex" /> инновационный CAt Toolls инструмент
        </p>
      </div>
  ...
  focus:border-[#C2F041] focus:ring-2 focus:ring-[#C2F041] outline-none transition-colors"
      ...
      <div className="flex gap-x-[3vw] w-full mt-1">
        <input
          type="checkbox"
          className="min-w-[24px] h-[24px] border-[#a1a1a1] accent-[#C2F041] cursor-pointer"
        />
      ...
      <div className="flex gap-x-[3vw] w-full items-center mb-1">
        <input
          type="checkbox"
