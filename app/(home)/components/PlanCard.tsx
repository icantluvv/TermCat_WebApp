...
const PlanCardDesktop = () => (
  <Link
    className="rounded-[24px] w-full md:w-[48%] hidden xl:flex xl:w-full bg-[#a1a1a1]/50 active:opacity-85 transition-all relative overflow-hidden"
    href={""}
  >
...
const PlanCardMobile = () => (
  <Link
    className="rounded-[24px] w-full md:w-[48%] flex xl:hidden bg-[#a1a1a1]/50 active:opacity-85 transition-all relative overflow-hidden"
    href={""}
  >
    <p className="text-black text-[1.5rem] p-[24px] flex flex-col xl:px-10 xl:py-[3vh] leading-8 z-[1000] font-cygre font-medium gap-y-4">
      Подробнее
      <br /> о тарифе Смарт
      <span className="text-[0.75rem] font-poppins font-regular">
        Исследуйте возможности своего тарифа
