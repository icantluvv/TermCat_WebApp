...
const LinkedServices = () => (
  <>
    {/* pc version */}
    <div className="bg-[#E8E8E8] hidden lg:flex lg:min-w-[435px] flex-col rounded-[24px] relative self-start">
      <div className="w-full pl-[40px] py-[40px] pr-[100px] flex flex-col gap-y-8 z-[5000]">
