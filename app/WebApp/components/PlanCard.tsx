...
const PlanCard = () => {
  return (
    <Link
      className="rounded-[24px] w-full lg:min-h-[194px] relative overflow-hidden flex"
      href={""}
    >
      <p className="text-black text-[1.5rem] md:text-[2rem] p-[24px] flex flex-col xl:px-10 xl:py-[3vh] leading-8 font-cygre font-medium gap-y-4 z-[1000]">
        Подробнее
        <br /> о тарифе Смарт
