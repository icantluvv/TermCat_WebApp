...
import background from "@/public/images/homepage/history_mobile_back.svg"
...
const HistoryCard = () => {
  return (
    <Link
      className="rounded-[24px] flex-1 md:w-[48%] xl:w-full bg-[#a1a1a1]/60 text-white px-8 py-10 hover:opacity-85 transition-all relative overflow-hidden"
      href={"/history"}
    >
      <Image
        src={background}
