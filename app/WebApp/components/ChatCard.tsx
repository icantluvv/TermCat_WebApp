...
const ChatCard = () => {
  return (
    <Link
      className="order-[0] w-full md:w-[calc(50%-6px)] lg:w-[calc(50%-20px)] min-h-[200px] rounded-[24px] bg-PrimaryBlack flex text-white active:opacity-85 transition-all relative overflow-hidden"
      href={"/chat"}
    >
      <div className="w-full p-[24px] lg:py-[48px] z-[1000]">
