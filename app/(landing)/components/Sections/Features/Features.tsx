...
const FourthSection = () => {
    return (
        <section
            className="container items-center flex flex-col gap-y-[40px] lg:gap-0 px-[4vw] lg:px-0 md:py-[170px] relative ">
            <div className=" flex flex-col gap-[24px] xl:gap-[40px] items-center text-center">
                ...
                <Typography className={'w-full max-w-[80vw] lg:max-w-[37vw]'} color='darkGray' variants={'p'}>
