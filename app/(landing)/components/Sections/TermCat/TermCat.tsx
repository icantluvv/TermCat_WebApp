    ...
    return (
        ...
        >
            <div className="flex flex-col md:gap-[12px] md:w-auto xl:gap-[24px]">
                ...
                <Typography variants='p' color='darkGray' className={'xl:flex hidden'}>Теперь не нужно тратить время на
                    перевод
                    терминов <br/> и определение
                    тематики, нейросетевая CAT-Tool <br/>
                    сделает всю работу за вас!
                </Typography>

                <Typography className={'hidden md:flex xl:hidden'} color='darkGray' variants={'p'}>
            ...
            <div className="flex flex-col gap-[12px] md:w-1/2">
                ...
                <Typography color={'darkGray'} variants={'p'} className='md:hidden w-[80vw]'>
