...
const Stats = () => {
    return (
        <section
            className="container flex flex-col items-center gap-[24px] md:gap-[40px] xl:gap-[80px] 2xl:max-w-[1400px]">
            <div
                className="w-full flex flex-col md:flex-row md:w-full items-start gap-[24px] px-[4vw] xl:px-0 md:justify-between">
                <>
                ...
                <div className="flex lg:flex-2 flex-col gap-[12px] lg:gap-[40px] md:w-1/2 mt-3">
                    ...
                    <Typography className={'hidden xl:flex'} color={'darkGray'} variants={'p'}>
                    ...
                    <Typography className={'flex xl:hidden'} color={'darkGray'} variants={'p'}>
