...
const Footer = () => {
    return (
        <footer
            className="flex flex-col justify-center gap-x-6 gap-y-[20px] xl:gap-y-[40px]  w-full z-[9000] px-[4vw] xl:px-0">
            <div
                className="flex justify-between flex-col md:flex-row gap-y-[20px] xl:gap-y-[40px] lg:items-center items-start">
                <Link href={"/#termcat"}>
                    <Image
                        src={footerlogo}
                        alt={"footerlogo"}
            ...
            <div className="flex w-full justify-between flex-col-reverse gap-y-[40px] md:flex-row">
                ...
                <Link
                    href={"/privacy"}
                >
                    <Typography variants={'custom'} className={'text-[14px] xl:text-[16px] hover:text-PrimaryGreen'}
                                color='lightGray'>
                        Документы
                    </Typography>
                </Link>
