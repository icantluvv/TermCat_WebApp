    ...
    <div className="bg-[#E8E8E8] flex rounded-[24px] w-full md:w-[calc(50%-10px)] xl:w-[calc(55%-20px)] relative">
      ...
      <div className="z-[5000] p-[24px] lg:p-[40px] flex flex-col lg:flex-row gap-y-[24px] lg:gap-x-4 2xl:gap-x-10 lg:gap-y-0 w-full">
        ...
        <div className="flex w-full flex-col gap-y-[24px]">
          ...
          <InputField label="E-mail" type="email" placeholder={`${user.email}`} />
          <InputField disabled label="Старый пароль" type="password" placeholder="" />
        ...
        >
          <Image src={redact_info} alt="Редактировать" className="w-1/2 h-1/2" />
        </button>
      </div>

      {/* background */}
      <Image src={back} className="w-full h-full absolute opacity-10 rounded-[24px]" alt="background" />
    </div>
  </>
)
