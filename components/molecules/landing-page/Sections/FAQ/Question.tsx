...
const Question = ({ title, text }: QuestionProps) => {
  ...
  return (
    ...
    >
      <Typography className="w-full pr-[5%] text-PrimaryBlack" start variants="h5" weight="medium">
        {title}
      </Typography>
      ...
      >
        <Typography className="text-[16px] lg:text-[18px] text-PrimaryBlack/60 max-w-[95%]" variants={"button"}>
          {text}
        </Typography>
      </div>
