...
const FirstSection = () => {
  return (
    <section
      id="termcat"
      className="flex scroll-mt-[200px] flex-col md:flex-row justify-between gap-[24px] md:gap-[48px] mt-[40px] xl:mt-[80px] mb-[40px] xl:mb-[160px]"
    >
