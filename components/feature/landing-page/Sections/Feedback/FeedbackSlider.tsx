  ...
  return (
    <div className="w-full mt-[40px] flex-col relative items-center gap-[40px] hidden xl:flex">
      <div className="text-center max-w-[850px] flex flex-col gap-[40px]">
        <p className="text-LightGray text-[18px] h-[100px]">{activeFeedback.text}</p>
        <div className="flex flex-col gap-[6px]">
          <h4 className="font-semibold text-LightGray text-[24px]">{activeFeedback.name}</h4>
      ...
      <div className="flex items-start h-[270px] overflow-hidden">
        {visibleFeedbacks.map((item, idx) => {
          ...
          const distanceFromCenter = Math.abs(idx - Math.floor(visibleFeedbacks.length / 2))
