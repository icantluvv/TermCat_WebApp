...
const cardData: CardItem[] = [
  {
    ...
    extraContent: <Image src={people} className="w-[85px] xl:w-[120px]" alt={"people"}></Image>
  },
  {
    id: 2,
  ...
  return (
    <Container>
      <section className={"mb-[40px] w-full xl:mb-[160px]"}>
        <div className="w-full flex flex-col md:flex-row md:w-full items-start gap-[24px] md:justify-between">
          ...
          <div className="flex lg:flex-2 flex-col gap-[12px] lg:gap-[40px] md:w-1/2 mt-3">
            <Typography className="hidden xl:flex" variants="p" color="darkGray">
              ...
              термины в тексте, предлагая наиболее подходящие переводы <br /> на основе контекста и ранее проверенных
              переводов
            </Typography>
            ...
            <div>
              <Link href={"/#points"}>
                <Button size="big" form="rounded" className="pr-[4px]" variant="emptyGreen">
                  ...
                  <div className="w-[24px] h-[24px] lg:w-[36px] lg:h-[36px] bg-PrimaryGreen rounded-full flex items-center justify-center">
                    <Image src={arrow} className="w-[13px] xl:w-[19px]" alt={""}></Image>
                  </div>
                </Button>
              </Link>
            </div>
      ...
      lg:justify-between px-[4vw] xl:px-0 no-scrollbar mt-[24px] md:mt-[40px] xl:mt-[80px] max-w-[1440px]"
        >
          {cardData.map((item) => (
