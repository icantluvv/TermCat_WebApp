...
const defaultButtonVariants =
  "transition-colors duration-[.3] cursor-pointer flex items-center justify-center inline-flex"
...
const variantsButton = {
  ...
  variant: {
    default: "",
    image: "",
    primary: "bg-PrimaryGreen hover:bg-PrimaryGreenHover active:bg-PrimaryGreenActive text-PrimaryBlack",

    empty: "border-[1.5px] border-lightGray text-LightGray hover:text-PrimaryGreen active:border-[#DDDDDD]",
