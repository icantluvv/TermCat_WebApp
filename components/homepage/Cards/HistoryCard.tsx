...
import background from "@/public/images/homepage/back.svg"
...
const HistoryCard = () => {
  return (
    // <Link
    //   className="rounded-[24px]  xl:flex flex-1  md:w-[48%] xl:w-full bg-[#a1a1a1]/60 text-white px-8 py-10 hover:opacity-85 transition-all relative overflow-hidden"
    //   href={"/history"}
    // >
    //   <Image
    //     src={background}
    ...
    //       <h3 className="text-black fomt-medium text-[2rem] w-full font-cygre font-medium">
    //         История
    //       </h3>
    ...
    //         </p>
    //       </div>
    //       {/* <Image src={form} className="absolute h-full" alt={""}></Image> */}
    //     </div>
    ...
    <Link
      className="rounded-[24px] xl:flex flex-1 md:w-[48%] xl:w-full text-white px-8 xl:py-10 hover:opacity-85 transition-all relative overflow-hidden"
      href={"/history"}
    >
      <Image
        src={background}
