...
const HistoryCard = () => {
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col w-full h-full gap-6 items-center justify-between z-[1000]">
          <div className="flex justify-between w-full">
            <h3 className="text-black fomt-medium text-[2rem] w-full">
              История
            </h3>
      ...
      <Link
        className="rounded-[24px] flex xl:hidden md:w-[48%] xl:w-full bg-[#a1a1a1]/60 flex-1 text-white px-8 py-[3vh] active:opacity-85 transition-all relative overflow-hidden"
        href={"/history"}
      >
        <Image
          src={background}
          ...
          alt={""}
        ></Image>
        <div className="flex flex-col w-full h-full gap-4 items-center justify-between z-[1000]">
          <div className="flex justify-between w-full">
            <h3 className="text-black fomt-medium text-[2rem] w-full">
              История
            </h3>
            <div className="rounded-[50%] bg-[#e8e8e8] min-w-[48px] absolute right-0 top-0 m-4 min-h-[48px] flex items-center justify-center">
              <Image src={arrow} className="w-1/3 h-1/3" alt={""}></Image>
            </div>
          </div>

          <div className="w-full relative flex h-full">
            <div className="flex z-[1000] p-3 flex-col gap-y-1">
              <Image
                src={folder}
                alt={""}
                className="w-[15px] h-[15px] scale-[200%]"
              ></Image>
              <p className="text-[#e8e8e8] text-[20px] max-w-[80%] flex-1">
                Следите за всеми <br />
                вашими переводами
              </p>
              <p className="font-light text-[#a1a1a1] text-[12px] ">
                Наша система сохраняет каждую вашу сессию
              </p>
            </div>
            <Image
          ...
          <div className="w-full justify-center items-end flex flex-1">
            <button className="bg-[#e8e8e8] flex gap-2 text-black px-[5vw] py-[1vh] rounded-[2vh]">
              <Image src={elemetn_plus} alt={""}></Image>
              Создать новый проект
            </button>
          </div>
