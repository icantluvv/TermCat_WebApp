...
const ChatCard = () => {
  return (
    <>
      {/* pc version */}
      <Link
        className="rounded-[24px] w-full xl:w-[48%] hidden xl:flex text-white hover:opacity-85 transition-all relative overflow-hidden"
        href={"/chat"}
      >
      ...
      {/* mobile version */}
      <Link
        className="rounded-[24px] w-full xl:w-[48%] flex xl:hidden text-white active:opacity-85 transition-all relative overflow-hidden"
        href={"/chat"}
      >
        <div className="w-full px-8 py-10 z-[1000]">
          <h3 className="text-[2.625rem] leading-[120%]">
