...
const HistoryCard = () => {
  return (
    <Link
      className="rounded-[24px] flex w-full bg-[#a1a1a1]/60 flex-1 text-white p-5 hover:opacity-50 transition-all relative overflow-hidden"
      href={"/history"}
    >
      <Image
        src={background}
        ...
        alt={""}
      ></Image>
      <div className="flex flex-col w-full h-full items-center z-[1000]">
        ...
        <div className="w-full mt-[5%] relative flex max-h-[500px]">
